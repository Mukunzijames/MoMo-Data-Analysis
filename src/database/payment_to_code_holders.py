...
def classify_transaction_type(body):
    ...
    if "your payment of" in body_lower and "to" in body_lower:
...
def main():
    ...
    save_to_json(transactions, "payment_to_code_holders.json")
    print("✅ Payment to code holder transactions processed and saved to 'payment_to_code_holders.json'.")
